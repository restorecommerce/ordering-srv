...
ENV HOME=/home/app
ENV APP_HOME=/home/app/ordering-srv
...
# To build the image:
# docker build -t restorecommerce/ordering-srv .
#
# To create a container:
# docker create --name ordering-srv --net restorecms_default restorecommerce/ordering-srv
#
# To run the container:
# docker start ordering-srv
